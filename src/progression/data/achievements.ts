...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    progressTracker: profile => ({
      current: profile.totalGamesPlayed,
      required: 10,
    }),
  },
  {
  ...
  },
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.enemiesDestroyed,
      required: 100,
    }),
  },
  {
  ...
  },
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.bossesDefeated,
      required: 1,
    }),
  },
  {
  ...
  // =============================================================================
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.maxWaveReached,
      required: 5,
    }),
  },
  {
  ...
  },
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.damageTaken,
      required: 10000,
    }),
  },
  ...
  // =============================================================================
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.powerupsCollected,
      required: 50,
    }),
  },
  {
  ...
  },
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: Math.floor(profile.totalScore / 10),
      required: 10000,
    }),
  },
  ...
  // =============================================================================
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.bulletsShot,
      required: 50000,
    }),
  },
  {
    ...
    hidden: false,
    progressTracker: profile => ({
      current: profile.stats.damageDealt,
      required: 100000,
    }),
  },
  {
    ...
    condition: (_profile, session) =>
      session ? session.perfectWaves >= 15 : false,
  ...
  },
  {
    ...
    difficulty: 'gold',
    condition: profile =>
      profile.level >= 15 && profile.stats.maxWaveReached >= 8,
 ...
 * 難易度別アチーブメント取得
 */
export function getAchievementsByDifficulty(
  difficulty: Achievement['difficulty']
): Achievement[] {
  return ACHIEVEMENTS.filter(
    achievement => achievement.difficulty === difficulty
  );
}
