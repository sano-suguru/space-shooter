...
describe('システム統合テスト', () => {
    ...
    beforeEach(() => {
        ...
        // WaveManagerを初期化
        waveManager = new WaveManager(eventEmitter, gameObjectFactory, mockGame as any);
    ...
    describe('GameObjectFactory統合', () => {
        ...
        test('動的敵生成が正常に動作する', () => {
            const enemy = gameObjectFactory.createDynamicEnemy('SMALL', mockGame as any);
        ...
        test('フォールバック機能が正常に動作する', () => {
            ...
            const enemy = gameObjectFactory.createDynamicEnemy('MEDIUM', mockGame as any);
    ...
    describe('ProgressManager統合', () => {
        ...
        test('プレイヤー統計が正常に取得される', () => {
            ...
            expect(['improving', 'stable', 'declining']).toContain(stats.recentPerformance);
        });
