...
describe('PersistenceManager', () => {
    ...
    describe('プロファイル読み込み', () => {
        it('保存されたプロファイルを正しく読み込める', () => {
            ...
            localStorageMock.setItem('space_shooter_profile', JSON.stringify(originalProfile));
    ...
    describe('プロファイル検証', () => {
        it('不完全なプロファイルが補完される', () => {
            ...
            localStorageMock.setItem('space_shooter_profile', JSON.stringify(incompleteProfile));
            localStorageMock.setItem('space_shooter_profile_version', '1.0.0');
        ...
        it('負の値が正の値に修正される', () => {
            ...
            localStorageMock.setItem('space_shooter_profile', JSON.stringify(invalidProfile));
            localStorageMock.setItem('space_shooter_profile_version', '1.0.0');
    ...
    describe('バージョン管理', () => {
        it('異なるバージョンの場合は移行処理が実行される', () => {
            ...
            localStorageMock.setItem('space_shooter_profile', JSON.stringify(oldProfile));
    ...
    describe('ユーティリティ機能', () => {
        it('プロファイルをリセットできる', () => {
            ...
            expect(localStorageMock.removeItem).toHaveBeenCalledWith('space_shooter_profile');
            expect(localStorageMock.removeItem).toHaveBeenCalledWith('space_shooter_profile_version');
        });
