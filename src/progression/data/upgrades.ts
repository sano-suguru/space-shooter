...
export const UPGRADE_CONFIGS: UpgradeConfig[] = [
    // ===== 武器系アップグレード =====
    {
        id: 'rapid_fire',
        name: '速射改良',
        description: '射撃速度を向上させる。より速く弾丸を発射できるようになります。',
        category: 'weapon',
        maxLevel: 10,
        baseCost: 100,
        costMultiplier: 1.5,
    ...
    },
    {
        id: 'power_shot',
        name: '威力強化',
        description: '弾丸の威力を向上させる。敵により多くのダメージを与えられます。',
        category: 'weapon',
        maxLevel: 10,
        baseCost: 150,
        costMultiplier: 1.6,
    ...
    // ===== ユーティリティ系アップグレード =====
    {
        id: 'coin_magnet',
        name: 'コインマグネット',
        description: 'パワーアップの磁力範囲を拡大し、より遠くからでも吸収できます。',
        category: 'utility',
        maxLevel: 6,
        baseCost: 250,
        costMultiplier: 1.6,
    ...
    },
    {
        id: 'coin_bonus',
        name: 'コインブースト',
        description: '獲得コインを増加させます。アップグレード購入が効率的になります。',
        category: 'utility',
        maxLevel: 8,
        baseCost: 500,
        costMultiplier: 2.0,
 ...
 * カテゴリ別にアップグレード設定を取得
 */
export function getUpgradesByCategory(category: 'weapon' | 'defense' | 'utility'): UpgradeConfig[] {
 ...
 */
export function calculateUpgradeCost(config: UpgradeConfig, currentLevel: number): number {
 ...
 */
export function isUpgradeUnlocked(upgradeId: string, profile: PlayerProfile): boolean {
