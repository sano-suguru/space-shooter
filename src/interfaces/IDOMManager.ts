...
export interface IDOMManager {
  ...
  // イベント操作
  addEventListener(element: HTMLElement | Document, type: string, listener: EventListener): void;
  removeEventListener(element: HTMLElement | Document, type: string, listener: EventListener): void;
