...
describe('UpgradeManager', () => {
    ...
    describe('アップグレード情報取得', () => {
        ...
        it('カテゴリ別のアップグレードが正しく取得できる', () => {
            const weaponUpgrades = upgradeManager.getAvailableUpgradesByCategory('weapon');
            const defenseUpgrades = upgradeManager.getAvailableUpgradesByCategory('defense');
            const utilityUpgrades = upgradeManager.getAvailableUpgradesByCategory('utility');
