...
describe('EnemyGenerationSystem', () => {
    ...
    describe('generateEnemy', () => {
        ...
        it('should apply difficulty scaling correctly', () => {
            ...
            // 高難易度の敵の方が強いはず
            expect(hardEnemy.stats.health).toBeGreaterThanOrEqual(easyEnemy.stats.health);
            expect(hardEnemy.stats.attackPower).toBeGreaterThanOrEqual(easyEnemy.stats.attackPower);
        });
    ...
    describe('generateWaveEnemies', () => {
        ...
        it('should apply wave and level difficulty', () => {
            ...
            expect(highLevelEnemies[0].stats.health).toBeGreaterThanOrEqual(lowLevelEnemies[0].stats.health);
        });
    });
